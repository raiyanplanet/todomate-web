      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center lg:text-left">
            ...
            >
              Stay productive and never miss a deadline with our beautiful, intuitive task management app. 
              Track progress, set priorities, and achieve your goals effortlessly.
            </motion.p>
                      ...
                      <div className="text-left">
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-blue-400 text-sm font-bold">40%</span>
                          </div>
                        ...
                        <div className="space-y-3">
                          {[
                            { color: 'orange', title: 'Design Review', subtitle: 'Due in 2 hours', delay: 2.8 },
                            { color: 'blue', title: 'Team Meeting', subtitle: '3 tasks remaining', delay: 3 },
                            { color: 'green', title: 'Code Review', subtitle: 'Almost done', delay: 3.2 }
                          ].map((task, index) => (
                            <motion.div
                              key={index}
                              ...
                              whileHover={{ scale: 1.02 }}
                            >
                              <div className={`w-10 h-10 bg-${task.color}-500 rounded-full flex items-center justify-center shadow-lg`}>
