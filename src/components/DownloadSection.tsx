...
const DownloadSection = () => {
  ...
  return (
    <section id="download" className="py-20 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 relative overflow-hidden">
      {/* Background Elements */}
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-8 mb-8">
                  ...
                  >
                    ...
                    <span className="text-slate-300 ml-2 font-semibold">4.8 rating</span>
                  </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg">Free Download</p>
                      <p className="text-slate-400">No hidden costs or subscriptions</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg">Cross Platform</p>
                      <p className="text-slate-400">Available on iOS, Android & Web</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
