...
import devlepoer from "../assets/me.jpg";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          <motion.p
            ...
            Built with passion and attention to detail by a dedicated developer
            who understands productivity.
          </motion.p>
        </motion.div>
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-center">
                <motion.div className="lg:col-span-1" variants={itemVariants}>
                  <div className="relative">
                    <motion.div
                      className="w-56 h-56 mx-auto bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 rounded-full flex items-center justify-center text-white text-6xl font-bold shadow-2xl overflow-hidden"
                      whileHover={{ scale: 1.05, rotate: 5 }}
                      transition={{ duration: 0.3 }}>
                      <img src={devlepoer} alt="Tawsiful ALam Raiyan" />
                    </motion.div>
                ...
                <motion.div className="lg:col-span-2" variants={itemVariants}>
                  ...
                  <motion.p
                    ...
                    variants={itemVariants}>
                    Passionate mobile and web developer with expertise in
                    creating beautiful, user-friendly applications. I believe in
                    building tools that make people's lives easier and more
                    productive. TaskFlow is the result of my commitment to
                    excellent design and seamless user experience.
                  </motion.p>
